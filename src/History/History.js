...
class History extends Component {
    ...
    // This function gets ETH price for a specific timestamp/date. The date is passed in as a argument
    getETHPrices(date) {
    ...
    getTodayPrice() {
        ...
        let t = moment().unix()
        // axios.all is used to make concurrent API requests. Theses requests were the functions we first created and they accept an argument of the date required.
    ...
    getYesterdayPrice () {
        ...
        axios.all([this.getETHPrices(t), this.getBTCPrices(t), this.getLTCPrices(t)])
            .then(axios.spread((eth, btc, ltc) => {
                ...
                // Set the state of yesterdayprie to the content of the object f
